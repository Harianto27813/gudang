...
<section class="content">
    <form class="form-group" action={{route('barang.binput')}} method="post"  enctype="multipart/data" >
    @csrf
        <div class="row">
        <div class="col-2">
        </div>
        ...
        <div class="card card-primary">
          ...
          @error('nama_barang')
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('stok') is-invalid @enderror" name="stok" value="{{ old('stok') }}" placeholder="Masukkan Jumlah Stok">
            @error('stok')
              <div class="invalid-feedback">
